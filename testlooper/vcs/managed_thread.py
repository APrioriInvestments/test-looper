...
import threading
import traceback
from .thread_local_stack import ThreadLocalStack
from .stack_info import get_traces
...
class ManagedThread(threading.Thread):
    def __init__(self, *args, **kwargs):
        ...
        self.creatorThreadLocalStorageDict = ThreadLocalStack.copyContents()
    ...
    def run(self):
        ...
        ThreadLocalStack.setContents(self.creatorThreadLocalStorageDict)
